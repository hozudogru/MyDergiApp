...
namespace MyDergiApp.Migrations
{
    ...
    [Migration("20260609055125_AddPublishedArticlePublishingFields")]
    partial class AddPublishedArticlePublishingFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyDergiApp.Models.HomePageSettings", b =>
                {
                    ...
                    b.Property<string>("BannerLabel")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");

                    b.Property<string>("BannerPrimaryButtonText")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");

                    b.Property<string>("BannerPrimaryButtonUrl")
                        .HasMaxLength(300)
                        .HasColumnType("character varying(300)");

                    b.Property<string>("BannerSecondaryButtonText")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");

                    b.Property<string>("BannerSecondaryButtonUrl")
                        .HasMaxLength(300)
                        .HasColumnType("character varying(300)");
                    ...
                    b.Property<string>("HeaderRightText")
                        .HasMaxLength(300)
                        .HasColumnType("character varying(300)");
                    ...
                    b.Property<bool>("ShowHeaderLogo")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("MyDergiApp.Models.IssueArticle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("PublishedAbstract")
                        .HasColumnType("text");

                    b.Property<string>("PublishedAuthors")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("MyDergiApp.Models.PublishedArticle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MyDergiApp.Models.SubmissionReviewer", b =>
                {
                    ...
                    b.HasIndex("SubmissionId", "ReviewerId", "ReviewRound")
                        .IsUnique();
            ...
            modelBuilder.Entity("MyDergiApp.Models.IssueArticle", b =>
                {
                    b.HasOne("MyDergiApp.Models.Issue", "Issue")
                        .WithMany("IssueArticles")
